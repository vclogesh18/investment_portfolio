...
const InvestmentClassesPage = () => {
  ...
  // Get investment classes from API
  const investmentClassesSection = features?.find((feature: any) => feature.section_name === 'investment_classes');
  const investmentClasses = investmentClassesSection?.items || [];
